...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Modern Navigation */}
      <nav className="nav-modern fixed top-0 left-0 right-0 z-50 py-4">
        <div className="container-modern flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold text-primary-navy">Edujiin</span>
          </Link>
          
          <div className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-secondary-gray hover:text-primary-blue font-medium transition-colors">Features</a>
            <a href="#how-it-works" className="text-secondary-gray hover:text-primary-blue font-medium transition-colors">How It Works</a>
            <a href="#testimonials" className="text-secondary-gray hover:text-primary-blue font-medium transition-colors">Success Stories</a>
            <a href="#pricing" className="text-secondary-gray hover:text-primary-blue font-medium transition-colors">Pricing</a>
          </div>
          
          <div className="flex items-center space-x-4">
            <Link href="/dashboard" className="btn-outline">Sign In</Link>
        ...
        <div className="container-modern">
          <div className="text-center max-w-4xl mx-auto fade-in">
            <h1 className="text-5xl md:text-6xl font-bold text-primary-navy mb-6 leading-tight">
              Your Smart Path to
              <span className="bg-primary-gradient bg-clip-text text-transparent"> Global Education</span>
            </h1>
            <p className="text-xl text-secondary-gray mb-8 max-w-2xl mx-auto">
        ...
        <div className="container-modern">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Link key={index} href="/dashboard" className="feature-card group">
                <div className={`feature-icon bg-gradient-to-br ${feature.gradient} group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold text-primary-navy mb-3">{feature.title}</h3>
        ...
        <div className="container-modern">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="card-modern text-center">
              <h3 className="text-2xl font-bold text-primary-navy mb-2">Free</h3>
              <div className="text-4xl font-bold text-primary-blue mb-4">$0</div>
              <p className="text-secondary-gray mb-6">Perfect for getting started</p>
              ...
              <Link href="/dashboard" className="btn-outline w-full">Get Started</Link>
            </div>

            {/* Pro Plan */}
            <div className="card-modern text-center border-2 border-primary-blue relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-accent-gradient text-white px-4 py-1 rounded-full text-sm font-semibold">Most Popular</span>
              </div>
              <h3 className="text-2xl font-bold text-primary-navy mb-2">Pro</h3>
              <div className="text-4xl font-bold text-primary-blue mb-4">$29</div>
              <p className="text-secondary-gray mb-6">AI-powered personalized guidance</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-accent-green mr-3" />
              ...
              <Link href="/dashboard" className="btn-primary w-full">Upgrade to Pro</Link>
            </div>

            {/* Premium Plan */}
            <div className="card-modern text-center">
              <h3 className="text-2xl font-bold text-primary-navy mb-2">Premium</h3>
              <div className="text-4xl font-bold text-primary-blue mb-4">$99</div>
              <p className="text-secondary-gray mb-6">Complete guidance package</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-accent-green mr-3" />
              ...
              <Link href="/dashboard" className="btn-secondary w-full">Contact Sales</Link>
            </div>
          </div>
        </div>
      </section>
